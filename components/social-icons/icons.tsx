...
export function Medium(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg width="43" height="24" viewBox="0 0 43 24" fill="none" {...svgProps}>
      <g clipPath="url(#clip0_3_2)">
        <path d="M23.8364 12.0002C23.8364 18.6275 18.5004 24 11.9184 24C5.33644 24 0 18.6263 0 12.0002C0 5.37409 5.33603 0 11.9184 0C18.5008 0 23.8364 5.37288 23.8364 12.0002ZM36.9109 12.0002C36.9109 18.2384 34.2428 23.2975 30.9517 23.2975C27.6605 23.2975 24.9925 18.2384 24.9925 12.0002C24.9925 5.76201 27.6601 0.702941 30.9513 0.702941C34.2424 0.702941 36.9105 5.76039 36.9105 12.0002M42.2586 12.0002C42.2586 17.5881 41.3204 22.1208 40.1628 22.1208C39.0051 22.1208 38.0673 17.5893 38.0673 12.0002C38.0673 6.41109 39.0055 1.87964 40.1628 1.87964C41.32 1.87964 42.2586 6.41069 42.2586 12.0002Z" />
      </g>
      <defs>
        <clipPath id="clip0_3_2">
          <rect width="42.2586" height="24" fill="white" />
        </clipPath>
      </defs>
    </svg>
  )
